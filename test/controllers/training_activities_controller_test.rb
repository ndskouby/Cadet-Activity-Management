...
class TrainingActivitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create training_activity' do
    assert_difference('TrainingActivity.count') do
      post training_activities_url,
           params: { training_activity: { title: 'New Training', activity_type: 'Military', description: 'Description',
                                          start_time: '2024-02-09', end_time: '2024-02-10' } }
    end
